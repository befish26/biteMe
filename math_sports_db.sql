...
ALTER TABLE QUESTION_SET ADD CONSTRAINT FOREIGN KEY(question_id) REFERENCES STUDENT_PROGRESS(student_id);
...
INSERT INTO QUESTION_SET(question_set_name, difficulty) VALUES ('Addition', 'Easy');
